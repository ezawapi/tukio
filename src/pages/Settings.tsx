...
const Settings = () => {
  ...
  const toggleNearbyNotif = (checked: boolean) => {
    ...
    toast({ title: checked ? "Notifications activées" : "Notifications désactivées", description: checked ? "Vous serez alerté des nouvelles activités à proximité." : "Vous ne recevrez plus d'alertes de proximité." });
  };
  ...
  const changeReminderDays = (value: string) => {
    ...
    if (value === "0") {
      ...
      toast({ title: `Rappel activé : ${value} jour(s) avant` });
    }
  };
              ...
              {isInstalled || isStandalone ? (
                ...
                <div className="space-y-3">
                  <p className="font-body text-sm text-muted-foreground">
                    Installez Tukio pour un accès rapide, même hors ligne.
                  </p>
                ...
                <div className="space-y-3">
                  <p className="font-body text-sm text-muted-foreground">
                    Installez Tukio directement depuis votre navigateur.
                  </p>
                  {isIOS ? (
              ...
              <div className="space-y-2 font-body text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-foreground font-medium">
                    {isStandalone ? "App installée" : "Navigateur web"}
                  </span>
                </div>
                <div className="flex justify-between">
